...
columnname = ["CROP NAME" , "GENERAL INFORMATION" , "SOIL INFORMATION"]
...
while(True):
	try:
		...
		with open('/home/p2/Documents/Minor 2/Apni Kheti/cropinfo.csv', 'a') as csvfile:
